...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scrollAnimations = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MobileMenu = function () {
		function MobileMenu() {
			...
			this.menuIcon = (0, _jquery2.default)(".primary-header__menu-icon");
			this.mainNav = (0, _jquery2.default)(".main-nav");
			this.logo = (0, _jquery2.default)(".primary-header__logo");
			this.events();
		}
				...
				this.animateItems.each(function () {
					...
					new Waypoint({
						...
						handler: function handler() {
							(0, _jquery2.default)(currentItem).addClass("animate-item--is-visible");
						},
						offset: "75%"
					});
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StickyHeader = function () {
		function StickyHeader() {
			...
			this.primaryHeader = (0, _jquery2.default)(".primary-header");
			this.headerTrigger = (0, _jquery2.default)("#what-we-do");
			this.mainNavLinks = (0, _jquery2.default)(".main-nav a");
			this.createHeaderWaypoint();
			this.pageSections = (0, _jquery2.default)(".page-section, .large-hero");
		...
		_createClass(StickyHeader, [{
			...
			key: 'createSectionsWaypoints',
			value: function createSectionsWaypoints() {
				var that = this;
					...
					new Waypoint({
						...
						handler: function handler(direction) {
							if (direction == "down") {
								...
								(0, _jquery2.default)(matchingLink).addClass("is-active");
							}
						},
						offset: "15%"
					});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = function () {
		function Form() {
			...
			this.form = (0, _jquery2.default)(".contact-us__form");
			this.fields = this.form.find("input:not(:submit), textarea");
			this.messageBox = (0, _jquery2.default)(".form-message");
			this.events();
		} //constructor()
		...
		_createClass(Form, [{
			...
			value: function checkFields() {
				var field = (0, _jquery2.default)(this),
				    empty = _jquery2.default.trim(field.val()) === "";
			...
			value: function checkForm(event) {
				...
				this.fields.each(function (i, elem) {
					var field = (0, _jquery2.default)(elem),
					    empty = _jquery2.default.trim(field.val()) === "";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = function () {
		function Modal() {
			...
			this.openBtn = (0, _jquery2.default)('.modal__open');
		...
		_createClass(Modal, [{
			...
			value: function events() {
				...
				(0, _jquery2.default)(document).on('keyup', this.keyPressClose.bind(this));
			}
		}, {
			key: 'openModal',
			...
			key: 'keyPressClose',
			value: function keyPressClose(event) {
				if (event.which == 27) {
					this.closeModal();
				}
			}
